...
mock_decode("org-write-jwt") := [{}, {"scope": "openid profile email write:organizations"}, {}]

mock_decode_verify("org-read-jwt", _) := [true, {}, {}]

mock_decode("org-read-jwt") := [{}, {"scope": "openid profile email read:organizations"}, {}]

mock_decode_verify("device-write-jwt", _) := [true, {}, {}]

mock_decode("device-write-jwt") := [{}, {"scope": "openid profile email write:devices"}, {}]

mock_decode_verify("device-read-jwt", _) := [true, {}, {}]

mock_decode("device-read-jwt") := [{}, {"scope": "openid profile email read:devices"}, {}]

mock_decode_verify("user-write-jwt", _) := [true, {}, {}]

mock_decode("user-write-jwt") := [{}, {"scope": "openid profile email write:users"}, {}]

mock_decode_verify("user-read-jwt", _) := [true, {}, {}]

mock_decode("user-read-jwt") := [{}, {"scope": "openid profile email read:users"}, {}]
