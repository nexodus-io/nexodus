...
type ApiListUsersInOrganizationRequest struct {
	ctx        context.Context
	ApiService *UsersApiService
	id         string
}

func (r ApiListUsersInOrganizationRequest) Execute() ([]ModelsUser, *http.Response, error) {
	return r.ApiService.ListUsersInOrganizationExecute(r)
}

/*
ListUsersInOrganization List Users

Lists all users for this Organization

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id Organization ID
	@return ApiListUsersInOrganizationRequest
*/
func (a *UsersApiService) ListUsersInOrganization(ctx context.Context, id string) ApiListUsersInOrganizationRequest {
	return ApiListUsersInOrganizationRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return []ModelsUser
func (a *UsersApiService) ListUsersInOrganizationExecute(r ApiListUsersInOrganizationRequest) ([]ModelsUser, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "UsersApiService.ListUsersInOrganization")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/organizations/{id}/devices"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
