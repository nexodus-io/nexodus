...
func (a *SecurityGroupApiService) GetSecurityGroupExecute(r ApiGetSecurityGroupRequest) (*ModelsSecurityGroup, *http.Response, error) {
	...
	localVarPath := localBasePath + "/api/organizations/{organization_id}/security_groups/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"organization_id"+"}", url.PathEscape(parameterValueToString(r.organizationId, "organizationId")), -1)
...
type ApiPatchSecurityGroupDeviceRequest struct {
	ctx             context.Context
	ApiService      *SecurityGroupApiService
	organizationId  string
	deviceId        string
...
func (r ApiPatchSecurityGroupDeviceRequest) Execute() (*ModelsDevice, *http.Response, error) {
	return r.ApiService.PatchSecurityGroupDeviceExecute(r)
}

/*
PatchSecurityGroupDevice Update Device Security Group

Updates a Device's Security Group by ID

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organizationId Organization ID
	@param deviceId Device ID
	@param securityGroupId Security Group ID
	@return ApiPatchSecurityGroupDeviceRequest
*/
func (a *SecurityGroupApiService) PatchSecurityGroupDevice(ctx context.Context, organizationId string, deviceId string, securityGroupId string) ApiPatchSecurityGroupDeviceRequest {
	return ApiPatchSecurityGroupDeviceRequest{
		ApiService:      a,
		ctx:             ctx,
		organizationId:  organizationId,
...
//
//	@return ModelsDevice
func (a *SecurityGroupApiService) PatchSecurityGroupDeviceExecute(r ApiPatchSecurityGroupDeviceRequest) (*ModelsDevice, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "SecurityGroupApiService.PatchSecurityGroupDevice")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/api/organizations/{organization_id}/devices/{device_id}/security_groups/{security_group_id}"
	localVarPath = strings.Replace(localVarPath, "{"+"organization_id"+"}", url.PathEscape(parameterValueToString(r.organizationId, "organizationId")), -1)
