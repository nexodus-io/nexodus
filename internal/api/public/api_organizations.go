...
/*
WatchEvents Watch events occurring in the organization

Watches events occurring in the organization

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param organizationId Organization ID
	@return ApiWatchEventsRequest
*/
func (a *OrganizationsApiService) WatchEvents(ctx context.Context, organizationId string) ApiWatchEventsRequest {
	return ApiWatchEventsRequest{
		ApiService:     a,
		ctx:            ctx,
...
func (a *OrganizationsApiService) WatchEventsExecute(r ApiWatchEventsRequest) (*ModelsWatchEvent, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
